...
<body>
	<div class="container well">
		...
		<div id="pageBody" class="wrapper-full">
			<div style="padding-top: 250px;height: 250px;font-weight: bold;">
		      	...
		      	<div id="textMessage" style="vertical-align: middle;float:left; font-size: 16px;height:79px; margin-top: 8px;">
		          	<a href="login.do" style="text-decoration: none;color:red;">OOPS! Unable to process your request right now, Seems like some internal error has been occurred.</a> 
		      	</div>
		    </div>
         </div>
		<!-- end -->
