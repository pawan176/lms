...
<link rel="stylesheet" href="css/pickmeup.css" type="text/css" />
  ...
  function cancelHelp(){
	  document.getElementById("coallocate").action = "ccoallocate.do";
	  document.getElementById("coallocate").submit();
  }
  function validate(){
...
<div class="popup-leadstatus mainpopup" style="display:block">
	<div class="popup-content">
		...
		<form action="referCase.do" id="coallocate">
				...
				<fieldset>
				   <ul>
				    ...
				    <li>
				    	...
				    	<input type="hidden" name="helpType" value="coallocate"/>				    
				    </li>
				    <li>
