...
<body>
	...
	<div class="contactHeader">
		...
		<div class="saveBtnList addedShow">
			<ul>
				<li><a class="saveandexit subheader-btn" href="#"> <span
						class="saveandexit-icon">
						<img src="resources/img/save-and-exit.png" style="width: 51px;"></img>Save and Exit
						</span> </a></li>
				<li><a class="savee subheader-btn" href="#"> <span
						class="savee-icon">
						<img src="resources/img/save.png" style="width: 36px;"></img>Save</span></a></li>

			</ul>
		</div>
		<div class="searchList">
			<div class="searchBox">
				<div class="searcharea1 fr">
