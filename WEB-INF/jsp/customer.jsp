		...
		<form method="post" action="" id="customerForm">
			...
			<div
				...
				<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
					<label><spring:message code="label.pan" /></label> <input
						type="text" placeholder="PAN Card No" name="companyPanNo"
						id="pan1" value="${customerDetail.companyPanNo}"
						onchange="pan_validate();" onchange="return checkPAN(this);"
						maxlength="10">
				...
				<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
					<%-- <label class="LabelHover">Type...<span
						style="display: none;"><spring:message
								code="label.typeOfBusiness" /></span></label>  --%>
			...
			<div class="row contactList leadstatus personalDetailForIndividual">
				...
				<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
					...
					<input type="text" value="${customerDetail.fName }" name="fName"
						id="fName" placeholder="First Name"
						onkeypress="return onlyCarector(event);" class="validField"
						maxlength="50">
				</div>
				<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
				...
				<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
					<label class="highlighted-eligibility"><spring:message
						...
						id="datepicker2"
						onchange="validateBirthDate(this);Calculateage();" name="dob"
						placeholder="Date of Birth"
						style="background-color: #D8FFFF; border: solid 1px #CCC !important;"><span
				...
				<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12 ">
					<label><spring:message code="label.pan" /><span>*</span></label> <input
						...
						name="pan" id="pan" placeholder="PAN Card No" maxlength="10"
						onchange="pan_validate();" onchange="return checkPAN(this);">
				</div>
				<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
				...
				<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
					<label><spring:message code="label.industry" /></label> <select
						name="industryId" onchange=getTypeOfBusinessName(this,"I")>
						<option value="-1">SELECT</option>
						<c:forEach var="obj"
							items="${customerMasterDetail.industryMaster}">
							<option value="${obj.industryId }"
			...
			<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
				...
				<select name="source" id="source1" class="validField"
					onblur="checksourcevalidation();">
					<option value="-1">select</option>
			...
			<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
				<label>Employee Name</label> <input type="text"
					value="${customerDetail.referenceName }" name="referenceName"
					id="referencename" placeholder="Refrence Name"
					onkeypress="return onlyCarector(event);" maxlength="50">
			</div>

			<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
				<label>Employee Code</label> <input type="text"
					value="${customerDetail.referenceNumber }" name="referenceNumber"
					id="referencenumber" placeholder="Refrence Number"
					onkeypress="return onlyNumeric(event);" maxlength="50">
			</div>
				...
				<div class="row contactList leadstatus occ-dtls">
					...
					<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12 field1">
						<label><spring:message code="label.designation" /></label><input
							type="text" name="desig" value="${customerDetail.desig}">
					</div>
					<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12 field1">
					...
					<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12 field1">
						<label class="highlighted-eligibility"><spring:message
								code="label.corp" /></label> <select name="corporateSalaryAccount">
				...
				<div class="row buttonHeading" style="border: none;">
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 btnPosition">
						...
						<button type="button" class="btn btn-primary addrow-detail"
							style="display: none;"
							value="${customerDetail.listAddress eq null ? '0' : fn:length(customerDetail.listAddress)}">Add</button>
					</div>
				</div>
				...
				<div class="row contactList leadstatus top-one-margin">
					...
					<c:forEach var="addressDetail"
						...
						<div class="mailingAddressDiv">
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
								<label>Address Type</label> <span class="sel-ttip"> <select
									id="listAddress[${addressStatus.index }].addressType"
									...
									name="listAddress[${addressStatus.index }].addressType"
									value="${addressDetail.addressType}" />
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
								<label>Destination Address</label> <input type="checkbox"
									...
									${addressDetail.destinationAddress=="Y"?'Checked':'' } />
							</div>
							...
							<div
								...
								id="listAddress[${addressStatus.index }].company_name_div">
								<label id="listAddress[${addressStatus.index}].company_label"
									class="minWidth labelcustomerwidth">Name Of Company</label>
								...
								<div
									...
									<input type="text"
										...
										id="listAddress[${addressStatus.index }].company_name">
								</div>
							</div>
							<div
							...
							<div
								...
								<div
									...
									<input type="text"
										...
										id="listAddress[${addressStatus.index }].flatNo">
								</div>
							</div>
							<div
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
								<label>Mobile No. 1</label> <input onchange="validateMobile(this);"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12"
								...
								<label>Mobile No. 2</label> <input onchange="validateMobile(this);"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
								<label>Phone no. 1</label> <input type="text" class="rgtAlign"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
								<label>Personal Email ID</label> <input maxlength="100" type="text"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12 landline2"
								id="listAddress[${addressStatus.index }].phone2_label">
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12 fax"
								id="listAddress[${addressStatus.index }].fax_div">
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12 currentaddyr"
								id="listAddress[${addressStatus.index }].occupancyYr_label">
								<label
									id="listAddress[${addressStatus.index }].occupancyYr_label"><spring:message
								...
								<input type="text" class="minWidth set-width widthcstm rgtAlign"
									...
									id="listAddress[${addressStatus.index }].occupancyYr" />
							...
							<div
								...
								<label
									...
									onkeypress="return onlyNumeric(event);" list="yearList"
									id="listAddress[${addressStatus.index }].currentareaYr" />
							...
							<div
								...
								id="listAddress[${addressStatus.index }]bussinessestablishment_address">
								<label
									id="listAddress[${addressStatus.index }].bussinessestbyr_label">Yrs Business Establishment</label>
									 <input type="text"
									class="minWidth set-width widthcstm rgtAlign"
							...
							<div
								...
								<div
									class="col-lg-4 col-md-3 col-sm-3 col-xs-3 padding-left-img padding-left-margin">
									<input id="listAddress[${addressStatus.index }].marketvalue"
										type="text"
							...
							<div
								...
								<div
									...
									<input type="text"
										name="listAddress[${addressStatus.index }].gstinno"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12 ownership">
								<label
								...
								<span class="sel-ttip"> <select
									...
									id="listAddress[${addressStatus.index }].occupancyStatus">
										<option value="-1">select</option>
			...
			<div class="row buttonHeading">
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-7 btnPosition">
					...
					<button type="button" class="btn btn-primary addrow-keycontacts"
						value="${customerDetail.keyContacts eq null ? '0' : fn:length(customerDetail.keyContacts)}">Add</button>
				</div>
			</div>
						...
						<tbody>
							<c:forEach var="key" items="${customerDetail.keyContacts }"
								...
								<tr>
									...
									<td><input type="text"
										value="${key.fname } ${key.mname} ${key.lname}"
									...
									<td><input type="text" value="${key.email}"
										...
										style="width: 130px" /></td>
									<td><input value="${key.address }" type="text"
					...
					<c:forEach var="property" items="${customerDetail.listProperty }"
						...
						<div class="row propertyCheckbox">
							<input type="checkbox" value="${property.propertyId }"
								...
								name="listProperty[${propStatus.index }].propertyId" />
						</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<label><spring:message code="label.propertyStatus" /></label> <select
								name="listProperty[${propStatus.index }].propStatus">
								<option value="-1">select</option>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<label><spring:message code="label.developerName" /></label> <select
								...
								onchange="populateProjectName(this);">
								<option value="-1">select</option>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<label><spring:message code="label.projectName" /></label> <select
								name="listProperty[${propStatus.index}].projectId">
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<label><spring:message code="label.city" /></label> <select
								name="listProperty[${propStatus.index }].city">
								<%-- <option value="-1">select</option>
									<c:forEach var="city" items="${customerMasterDetail.city}"> --%>
						...
						<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
							<label><spring:message code="label.pin" /></label> <input
								type="text" value="${property.zipcode }" class="rgtAlign"
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<label class="LabelHover">Occupacy ...<span
								...
								name="listProperty[${propStatus.index }].occupancyStatus">
								<option value="-1">select</option>
								<c:forEach var="status1"
...
$('#pan').val('');
		...
		var companynameletter=companyname.trim().substring(0,1);		
		if(companynameletter.trim().toUpperCase()!=pan1letter.trim().toUpperCase())
		{
		alert("INCORRECT PAN NUMBER");
		$('#pan1').val('');
